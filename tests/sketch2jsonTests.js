...
module.exports = [
  {
    ...
    test: check => {
      fs.readFile(__dirname + '/fixtures/simple.sketch', (error, data) => {
        sketch2json(data).then(({document}) => check(document))
      })
    },
  ...
  },
  {
    ...
    test: check => {
      fs.readFile(__dirname + '/fixtures/simple.sketch', (error, data) => {
        sketch2json(data).then(({meta}) => check(meta))
      })
    },
  ...
  },
  {
    ...
    test: check => {
      fs.readFile(__dirname + '/fixtures/simple.sketch', (error, data) => {
        sketch2json(data).then(({user}) => check(user))
      })
    },
  ...
  },
  {
    ...
    test: check => {
      fs.readFile(__dirname + '/fixtures/simple.sketch', (error, data) => {
        sketch2json(data).then(({pages}) => check(pages))
      })
    },
    shouldEqual: {
