...
const previewBase64 = fs.readFileSync(
  __dirname + '/fixtures/simple/previews/preview.png.base64'
).toString().trim()
...
module.exports = [
  ...
  {
    description: 'provides the preview',
    test: check => {
      fs.readFile(__dirname + '/fixtures/simple.sketch', (error, data) => {
        getSketchContents(data)
          .map(({preview}) => {
    ...
    shouldEqual: `data:image/png;base64,${previewBase64}`
  }
]
